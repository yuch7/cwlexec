...
Download the latest release available at https://github.com/IBMSpectrumComputing/cwlexec/releases/download/v0.1/cwlexec-0.1.tar.gz and extract the package.
