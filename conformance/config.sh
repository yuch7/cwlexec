...
sed -i "s/lsfadmins.*lsfadmin.*/lsfadmins     \(travis\)/g" $LSF_TOP/conf/lsbatch/cluster1/configdir/lsb.users
sed -i "s/Administrators = lsfadmin/Administrators = travis/g" $LSF_TOP/conf/lsf.cluster.cluster1
