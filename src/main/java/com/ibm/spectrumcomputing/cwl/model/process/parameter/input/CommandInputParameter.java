...
/**
 * Represents a CommandInputParameter object
 */
@JsonInclude(Include.NON_NULL)
public class CommandInputParameter extends CWLParameter {

    private CommandLineBinding inputBinding;

    /**
     * Constructs a CommandInputParameter object
     * 
     * @param id
     *            The ID of this object
     */
    public CommandInputParameter(String id) {
        this.id = id;
    }
